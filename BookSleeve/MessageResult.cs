...
namespace BookSleeve
{
    ...
    internal sealed class MessageResultNullableInt64 : MessageResult<long?>
    {
        ...
        protected override long? GetValue(RedisResult result)
        {
            return result.IsNil ? null : (long?) result.ValueInt64;
        }
    }
    ...
    internal sealed class MessageResultNullableDouble : MessageResult<double?>
    {
        ...
        protected override double? GetValue(RedisResult result)
        {
            return result.IsNil ? null : (double?) result.ValueDouble;
        }
    }
    ...
    internal sealed class MessageResultString : MessageResult<string>
    {
        ...
        protected override string GetValue(RedisResult result)
        {
    ...
    {
        protected override RedisResult GetValue(RedisResult result)
        {
            return result;
        }
    }
    ...
    internal sealed class MessageResultMultiString : MessageResult<string[]>
    {
        ...
        protected override string[] GetValue(RedisResult result)
        {
            return result.ValueItemsString();
        }
    }
    ...
    internal sealed class MessageResultBytes : MessageResult<byte[]>
    {
        ...
        protected override byte[] GetValue(RedisResult result)
        {
