                    ...
                    for (int i = 0; i < tokens.Length; i++)
                    {
                        ...
                        switch (key)
                        {
                            case "addr":
                                ...
                                break;
                            case "age":
                                client.AgeSeconds = int.Parse(value, CultureInfo.InvariantCulture);
                                break;
                            case "idle":
                                client.IdleSeconds = int.Parse(value, CultureInfo.InvariantCulture);
                                break;
                            case "db":
                                client.Database = int.Parse(value, CultureInfo.InvariantCulture);
                                break;
                            case "name":
                                client.Name = value;
                                break;
                            case "sub":
                                client.SubscriptionCount = int.Parse(value, CultureInfo.InvariantCulture);
                                break;
                            case "psub":
                                client.PatternSubscriptionCount = int.Parse(value, CultureInfo.InvariantCulture);
                                break;
                            case "multi":
                                client.TransactionCommandLength = int.Parse(value, CultureInfo.InvariantCulture);
                                break;
                            case "cmd":
