...
namespace BookSleeve
{
    ...
    public sealed class Counters
    {
        ...
        private readonly int errorMessages;
        private readonly int messagesCancelled;

        private readonly int messagesReceived;

        private readonly int messagesSent;
        private readonly int ping;

        private readonly int queueJumpers;

        private readonly int sentQueue;
        ...
        /// </summary>
        public int MessagesCancelled
        {
            get { return messagesCancelled; }
        }
        ...
        /// </summary>
        public int QueueJumpers
        {
            get { return queueJumpers; }
        }

        /// <summary>
        ///     The number of messages waiting to be sent
        /// </summary>
        public int UnsentQueue
        {
            get { return unsentQueue; }
        }
