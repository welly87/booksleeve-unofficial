...
namespace BookSleeve
{
    ...
    public sealed class RedisFeatures
    {
        ...
        public bool Persist
        {
            get { return version >= v2_1_2; }
        }

        /// <summary>
        ///     Can EXPIRE be used to set expiration on a key that is already volatile (i.e. has an expiration)?
        /// </summary>
        public bool ExpireOverwrite
        {
            get { return version >= v2_1_3; }
        }

        /// <summary>
        ///     Does HDEL support varadic usage?
        /// </summary>
        public bool HashVaradicDelete
        {
            get { return version > v2_2_0; }
        }
        ...
        /// </summary>
        public bool StringSetRange
        {
            get { return version >= v2_1_8; }
        }

        /// <summary>
        ///     Is RPUSHX and LPUSHX available?
        /// </summary>
        public bool PushIfNotExists
        {
            get { return version >= v2_1_1; }
        }

        /// <summary>
        ///     Does SADD support varadic usage?
        /// </summary>
        public bool SetVaradicAddRemove
        {
            get { return version >= v2_4_0; }
        }

        /// <summary>
        ///     Does INCRBYFLOAT / HINCRBYFLOAT exist?
        /// </summary>
        public bool IncrementFloat
        {
            get { return version >= v2_5_7; }
        }
        ...
        /// </summary>
        public bool MultipleRandom
        {
            get { return version >= v2_5_14; }
        }

        /// <summary>
        ///     Does BITOP / BITCOUNT exist?
        /// </summary>
        public bool BitwiseOperations
        {
            get { return version >= v2_5_10; }
        }

        /// <summary>
        ///     Is LINSERT available?
        /// </summary>
        public bool ListInsert
        {
            get { return version >= v2_1_1; }
        }
        ...
        {
            StringBuilder sb = new StringBuilder().Append("Features in ").Append(version).AppendLine()
